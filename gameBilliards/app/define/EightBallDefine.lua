...
EightBallDefine.ballLinearIncreaseMultiple = 1.2  --当球体速度小于ballDampingValue时，速度减少速率的倍数

EightBallDefine.ballLinearIncreaseDoubleMultiple = 1.5  --二次衰减速率减少倍数

EightBallDefine.ballDampingValue = 250*250   --球体衰减速度的速度阈值(多少速度就开始摩擦力翻倍)

EightBallDefine.ballDoubleDampingValue = 100*100  --球体速度二次衰减
...
EightBallDefine.lineForceRatio = 3000  --直线击打力量系数，越大力量越大
...
--白球初始位置
EightBallDefine.whiteBallOriginalPos = cc.p(355,300)
